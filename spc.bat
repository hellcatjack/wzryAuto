...
rem 点击一下防沉迷提示
adb shell input tap 830 512
choice /t 1 /d y /n >nul
adb shell input tap 990 610

choice /t %waitLoading% /d y /n >nul

echo 取消废话
if %skipStartDiag% == 0 goto skipend
adb shell input tap 1251 64
:skipend

choice /t 1 /d y /n >nul

echo 点击“自动”
rem adb shell input tap 1193 45

rem 选择英雄
if %selHero% == 1 adb shell input tap 60 80
if %selHero% == 2 adb shell input tap 60 180
if %selHero% == 3 adb shell input tap 60 280
